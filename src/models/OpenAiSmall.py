...
class OpenAiSmall(BaseModel):
    def __init__(self):
        super(OpenAiSmall, self).__init__()
        hyperparameters = config.training.hyperparameters

        self.dropout_rate = hyperparameters.dropout_rate
        logger.info(f"Initializing OpenAiSmall model with dropout rate: {self.dropout_rate}")
        ...
        logger.info("OpenAiSmall model initialization complete.")

    def forward(self, embeddings):
        logger.debug("Starting forward pass for OpenAiSmall model.")
        ...
        logger.debug("Computed representations for all levels in OpenAiSmall model.")
        ...
        logger.debug("Generated predictions for all levels in OpenAiSmall model.")

        logger.debug("Forward pass for OpenAiSmall model completed.")
