...
class XLNet(BaseModel):
    def __init__(self):
        ...
        logger.info(f"Initializing XLNet model with dropout rate: {self.dropout_rate}")
        ...
        logger.info("XLNet model initialization complete.")

    def forward(self, embeddings):
        logger.debug("Starting forward pass for XLNet model.")
        ...
        logger.debug("Computed representations for all levels in XLNet model.")
        ...
        logger.debug("Generated predictions for all levels in XLNet model.")

        logger.debug("Forward pass for XLNet model completed.")
